...
const AppBar = ({ onClick }) => {
  ...
  const classe = searchStyles();
  const appBarRight = barRight();
  ...
  function onClickSearch(queryparams) {
    queryParams.set("q", q);
  ...
  return (
    <MUIAppBar color="inherit" className={clsx(classes.appBar)}>
      <Toolbar className={classes.root}>
        <div className={classe.flexDiv}>
          <IconButton
            onClick={onClick}
            edge="start"
        ...
        <div className={classe.root}>
          <Input
            ...
            placeholder="  Search"
          ></Input>
          <Button onClick={() => onClickSearch(queryParams)}>
            <SearchIcon className={classe.searchbutton} />
          </Button>
        </div>

        <div className={appBarRight.root}>
          <VideoCallIcon className={appBarRight.icone} />
          <AppsIcon className={appBarRight.icone} />
          <NotificationsIcon className={appBarRight.icone} />
          {userStore.isLoggedIn && <Avatar />}
        </div>
        ...
        {userStore.user && (
          <Button onClick={userStore.logout} color="inherit">
            Logout
          </Button>
        )}
      </Toolbar>
